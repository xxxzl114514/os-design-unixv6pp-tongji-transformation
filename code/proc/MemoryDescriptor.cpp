...
void MemoryDescriptor::Initialize()
{
	...
	/*for (int i = 0; i < PageTable::ENTRY_CNT_PER_PAGETABLE; i++)
	{
		this->m_UserPageTableArray->m_Entrys[i].m_Present = 0;
		this->m_UserPageTableArray->m_Entrys[i].m_ReadWriter = 0;
		this->m_UserPageTableArray->m_Entrys[i].m_UserSupervisor = 1;
		this->m_UserPageTableArray->m_Entrys[i].m_PageBaseAddress = 0;
	}*/
}
