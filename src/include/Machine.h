...
public:
	...
	static const unsigned long KERNEL_PAGE_TABLE_ZERO_DIRECTORY = 0x202000;
	...
	static const unsigned long USER_PAGE_TABLE_BASE_ADDRESS_2 = 0x203000;
	...
	static const unsigned long KERNEL_SPACE_PAGE_SIZE = 0x1000;
...
public:
	...
	void InitVesaPageDirectory(uintptr_t videoMemAddr, uintptr_t virtualMemAddr, size_t videoMemSize, PageDirectory *pageDirectory);
#endif
...
public:
	...
	void SetPageDirectory(PageDirectory *pPageDirectory);		/* 设置当前使用的页目录表 */
	void SetUserPageTableArray(PageTable *pUserPageTableArray); /* 设置当前使用的用户页表数组 */
