...
void main0(void)
{
	...
	Machine::Instance().InitZeroProcUserTable(); // 初始化用户态页表
...
extern "C" unsigned char _user_code_end;
...
extern "C" void ExecShell()
{
	...
	__asm (".globl _user_code_end");
	__asm ("_user_code_end:");
